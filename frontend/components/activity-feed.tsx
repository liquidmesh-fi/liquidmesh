      ...
      <div className="flex-1 min-w-0">
        ...
        {txHash ? (
          <a
            ...
            className="text-xs text-cyan-400/60 hover:text-cyan-400 mt-0.5 truncate font-mono transition-colors block"
          >
            {detail} ↗
          </a>
        ) : (
...
function formatItem(item: FeedItem): {
  ...
  if (item.type === "score") {
    ...
    return {
      ...
      color: item.data.recommendation === "execute" ? "text-cyan-400" : "text-white/40",
      txHash: null,
    };
  }
